...
#define HM_BLUE_CHN  TIM_CHANNEL_1
#define HM_RED_CHN   TIM_CHANNEL_2
#define HM_GREEN_CHN TIM_CHANNEL_3
...
public:
    static void start(Settings *settings, TIM_HandleTypeDef *htim);
    static void stop();
